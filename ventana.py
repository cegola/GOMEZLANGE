...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.lblValidar.setGeometry(QtCore.QRect(270, 140, 31, 21))
        font = QtGui.QFont()
        ...
        self.lblCliAlta.setGeometry(QtCore.QRect(320, 140, 101, 16))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.editCliAlta.setGeometry(QtCore.QRect(430, 140, 91, 20))
        self.editCliAlta.setObjectName("editCliAlta")
        self.btnCalendar = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalendar.setGeometry(QtCore.QRect(530, 140, 31, 21))
